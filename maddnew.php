...
<body style="background-size: 100%" class="bg-gradient-seconday">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item ">
                    <a class="nav-link " href="mfirstPage.php">Home <span class="sr-only">(current)</span></a>
                </li>
    ...
    if (isset($_POST['saveAccount'])) {
        if (!$con->query("insert into useraccounts (name,cnic,accountNo,accountType,city,address,email,balance,source,number,branch) values ('$_POST[name]','$_POST[cnic]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[balance]','$_POST[source]','$_POST[number]','$_POST[branch]')")) {
            ...
            <div class="card-body bg-dark text-white">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <th>Deposit</th>
                            <td><input type="number" name="balance" min="100" class="form-control input-sm" required></td>
                            <tr>
                            </tr>
                           <th>Contact Number</th>
                            <td><input type="tel" name="number" class="form-control input-sm"  pattern="\d{10}" title="Please enter a 10-digit number" maxlength="10" required></td>
                        </tr>
                        <tr>
                            <th>Branch</th>
                            <td>
