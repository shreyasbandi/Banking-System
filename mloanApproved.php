        ...
        <div class="card w-100 text-center shadowBlue">
            ...
            <table class="table table-bordered table-sm">
                ...
                <tbody>
                    <?php
                    $i = 0;
                    $array = $con->query("SELECT la.id,la.userId,la.amount,la.reason,la.occupation,la.status,la.date,ua.name, ua.accountNo from loan_applications as la inner join useraccounts as ua on ua.id=la.userId WHERE la.status = 'Approved'");
                    if ($array->num_rows > 0) {
